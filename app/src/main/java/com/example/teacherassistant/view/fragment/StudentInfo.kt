...
class StudentInfo : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        viewModelGrade = ViewModelProvider(requireActivity()).get(GradeViewModel::class.java)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        AddGradeButton.setOnClickListener { x -> x.findNavController().navigate(R.id.action_student_to_addGrade) }
